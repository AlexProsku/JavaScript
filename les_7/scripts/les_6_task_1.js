...
function add_cart(value, name) {
    ...
    catalog.textContent = `Состав корзины: ${resName} `;

    let bask_xtore = JSON.stringify(basket);
    window.localStorage.basket = bask_xtore;
